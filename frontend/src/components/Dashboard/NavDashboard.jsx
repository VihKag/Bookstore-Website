import { faUser, faUserPlus, faUserTie, faUsers, faWarehouse } from "@fortawesome/free-solid-svg-icons";
...
const NavDashboard = () =>{
    const btnUser = [
      ...
      const btnSale = [
        {name : "Products ", link: "/admin/products", icon: <FontAwesomeIcon icon={faUsers} />},
        {name : "Categories", link: "/admin/categories", icon: <FontAwesomeIcon icon={faWarehouse} />},
        {name : "Add Product", link: "/admin/add_product", icon: <FontAwesomeIcon icon={faUserPlus} />},
      ];
                    ...
                    <div className="flex items-center">
                        <div className="flex items-center ml-3">
                            ...
                            <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                                ...
                                <img className="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user logo"/>
                            </button>
                            </div>
