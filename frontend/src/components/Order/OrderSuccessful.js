...
const OrderSuccessful = ({ orderid, message, redirecto }) => {
    ...
    const [orderdata, setorderdata] = useState({
        ...
        CustomerName: 'ThaiPhuc',
        CustomerShipToAddress: '30/3/8 hem 55, duong Binh Trieu, khu pho 7, phuong Hiep Binh, Thu Duc, Ho Chi Minh',
        CustomerEmail: 'thaiphuc@gmail.com',
        OrderItems: [
            {
    ...
    return (
        ...
        >
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#00d3b7" className="w-6 h-6">
