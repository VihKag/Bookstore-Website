      ...
      <div className="min-w-max bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
        <div className="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <div className="pr-2">
              <h5 className="leading-none text-xl font-bold text-gray-900 dark:text-white pb-1 rounded-md bg-green-400 p-2">{totalY.totalYSold}/Week</h5>
            </div>
            <div>
              <h5 className="leading-none text-xl font-bold text-gray-900 dark:text-white pb-1 rounded-md bg-red-400 p-2">{totalY.totalYReturn}/Week</h5>
            </div>
          </div>        
        </div>
